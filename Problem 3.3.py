...
for itr in range (0, iteration):
    ...
    Px = sum(x ** 2) / x.shape[0]
    mu = 1 / (3 * L * Px)
    weights1, error1 = rls(x, d, L,forget_factor)
    weights2, error2 = rls(xnoise, d, L, forget_factor)
...
plt.figure(1)
plt.subplot(2, 2, 1)
plt.plot(index, ErrorAve1**2, label='Original input', color='purple',ls='--')
plt.plot(index, ErrorAve2**2, label='Input with noise', color='b')
plt.legend()
...
plt.figure(1)
plt.subplot(2, 2, 3)
plt.semilogy(index, ErrorAve1**2, label='Original input', color='purple',ls='--')
plt.semilogy(index, ErrorAve2**2, label='Input with noise', color='b')
plt.legend()
plt.xlabel('sample number k')
...
plt.figure(1)
plt.subplot(2, 2, 2)
plt.plot(index, WeightErrorAve1, label='Original input', color='purple',ls='--')
plt.plot(index, WeightErrorAve2, label='Input with noise', color='b')
plt.legend()
plt.xlabel('sample number k')
...
plt.figure(1)
plt.subplot(2, 2, 4)
plt.semilogy(index, WeightErrorAve1, label='Original input', color='purple',ls='--')
plt.semilogy(index, WeightErrorAve2, label='Input with noise', color='b')
plt.legend()
plt.xlabel('sample number k')
